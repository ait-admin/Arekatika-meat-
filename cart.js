document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Event listener for UPI app selection buttons (attached once)
    document.querySelectorAll('#upi-app-selection button').forEach(button => {
        button.addEventListener('click', async () => {
            const userId = localStorage.getItem('userId'); // Get userId here as it might not be in scope otherwise
            const paymentMethod = 'UPI'; // Payment method is UPI for these buttons
